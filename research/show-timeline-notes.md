...
> the new grid. In the free-tempo parts (Vivaldi, Discorecord intro, bridge, Domitor, outro) 23 authored hit
> clusters are pinned to measured onsets (`onsets[]`, `scripts/audio-onsets.py`), e.g. Winter hit 1 at 47.94 s and
> the corner fireballs at 100.34 s. Evidence: `research/audio-map.md`; per-section table: `research/retime-report.md`.
